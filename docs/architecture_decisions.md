...
4.  **Kalshi v2 Schema Compatibility:** Parses all dollar-string and float payloads across snapshots and deltas, converting them reliably into internal 1–99 cent integer spaces.
